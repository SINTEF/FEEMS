...
class FuelConsumptionScalar(_message.Message):
    ...
    def __init__(self, fuels: _Optional[_Iterable[_Union[FuelScalar, _Mapping]]] = ...) -> None: ...

class FuelConsumptionRateArray(_message.Message):
    __slots__ = ("fuels",)
    FUELS_FIELD_NUMBER: _ClassVar[int]
    fuels: _containers.RepeatedCompositeFieldContainer[FuelArray]
    def __init__(self, fuels: _Optional[_Iterable[_Union[FuelArray, _Mapping]]] = ...) -> None: ...
...
class TimeSeriesResultForComponent(_message.Message):
    ...
    def __init__(self, time: _Optional[_Iterable[float]] = ..., power_output_kw: _Optional[_Iterable[float]] = ..., fuel_consumption_kg_per_s: _Optional[_Union[FuelConsumptionRateArray, _Mapping]] = ...) -> None: ...

class GHGEmissions(_message.Message):
    __slots__ = ("well_to_tank", "tank_to_wake", "well_to_wake", "tank_to_wake_without_slip", "well_to_wake_without_slip", "tank_to_wake_from_green_fuel", "tank_to_wake_without_slip_from_green_fuel")
...
class FeemsResultForMachinerySystem(_message.Message):
    ...
    def __init__(self, electric_system: _Optional[_Union[FeemsResult, _Mapping]] = ..., mechanical_system: _Optional[_Union[FeemsResult, _Mapping]] = ...) -> None: ...
