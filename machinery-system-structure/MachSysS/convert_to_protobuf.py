...
# %% auto 0
__all__ = ['convert_efficiency_curve_to_protobuf', 'convert_bsfc_curve_to_protobuf', 'convert_electric_machine_to_protobuf',
           'convert_electric_component_to_protobuf', 'convert_battery_component_to_protobuf',
           'convert_supercapacitor_component_to_protobuf', 'convert_serial_electric_system_to_protobuf',
           'convert_nox_calculation_method_to_protobuf', 'convert_emission_curves_to_protobuf',
           'convert_engine_component_to_protobuf', 'convert_switchboard_to_protobuf', 'convert_shaftline_to_protobuf',
           'convert_electric_system_to_protobuf', 'convert_electric_system_to_protobuf_machinery_system',
