from feems.components_model.component_electric import ShorePowerConnection, ShorePowerConnectionSystem, ElectricComponent
from feems.system_model import ElectricPowerSystem
from feems.types_for_feems import SwbId, Power_kW, TypeComponent, TypePower
...
def test_add_shore_power_to_electric_system():
    ...
    system = ElectricPowerSystem(
        name="Test System",
        power_plant_components=[shore_power],
        bus_tie_connections=[]
    )
