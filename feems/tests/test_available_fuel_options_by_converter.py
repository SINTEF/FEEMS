...
class TestAvailableFuelOptions(unittest.TestCase):
    ...
    def test_genset_options(self):
        ...
        self.assertEqual(len(options), len(set(options)), "Duplicate fuel options found for gensets")
    ...
    def test_fuel_cell_options(self):
        ...
        eps = ElectricPowerSystem(
            name="EPS FC",
            power_plant_components=[fcs1, fcs2],
            bus_tie_connections=[]
        )
        ...
        self.assertEqual(len(options), len(set(options)), "Duplicate fuel options found for fuel cells")
    ...
    def test_mechanical_propulsion_options(self):
        ...
        mps = MechanicalPropulsionSystem(
            name="MPS Test",
            components_list=[me_df]
        )
        ...
        # Check for duplicates
        self.assertEqual(len(options), len(set(options)), "Duplicate fuel options found for mechanical propulsion")
